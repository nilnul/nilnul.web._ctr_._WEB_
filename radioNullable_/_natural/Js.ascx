<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.radioNullable_._natural.Js" %>
			...
			pub = function () {
				Object.defineProperties(
					boxer,
					{
						...
						,
						replaceInBtns_with$parentOfHolders:{
