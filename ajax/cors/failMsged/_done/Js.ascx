<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.ajax.cors.failMsged._done.Js" %>
		...
		var boxer = child.parentElement
			...
			on = function () {
				...
				$failMsged.on(
					...
					,
					function (e, data) {
						showMsg( "<%=nilnul._web_._CTR_.lang.PerRequest.GetEnZh("Success","成功")%>" );
					}
				);
				$msger.on(
					'oked',
