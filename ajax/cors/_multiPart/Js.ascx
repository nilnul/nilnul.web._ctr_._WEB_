<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.ajax.cors._multiPart.Js" %>
...
<script>
	...
	;var <%=unique_func_name %>=function (child) {
		var boxer=child.parentElement
			...
			, 
			ini = function () {
				ajax.cfg.contentType= false;
				ajax.cfg.processData = false;
			}
			,
			on = function () {
				$ajax.on(
