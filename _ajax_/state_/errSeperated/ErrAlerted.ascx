<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ErrAlerted.ascx.cs" Inherits="nilnul.web._ctr_._WEB_._ajax_.state_.errSeperated.ErrAlerted" %>
...
<div style="position: relative">
	...
	<%@ Register Src="~/_ajax_/state_/ErrSeperated.ascx" TagPrefix="uc1" TagName="ErrSeperated" %>
	<uc1:ErrSeperated runat="server" id="ErrSeperated" />
