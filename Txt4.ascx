<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Txt4.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.Txt4" %>
<%--<%@ OutputCache Duration="3600000" VaryByParam="none" %>--%><%--cache will make the property access a null reference--%>
<%-----------------------------------------------
