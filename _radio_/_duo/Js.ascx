<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul.web._ctr_._WEB_._radio_._duo.Js" %>
			...
			tbody=children[i++]
				...
				tr=tbody.children[0]
					,trChildren=tr.children
						,btn0=trChildren[0].firstElementChild
						,btn1=trChildren[1].firstElementChild
			,
