<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ErrAlerted.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.ajax_.cors.ErrAlerted" %>
...
<%@ Register Src="../Cors.ascx" TagPrefix="uc1" TagName="Cors" %>
...
<div style="position:relative">
	<uc1:Cors runat="server" id="State1" />
