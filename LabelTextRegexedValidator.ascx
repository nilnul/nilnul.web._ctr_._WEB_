<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LabelTextRegexedValidator.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.LabelTextRegexedValidator" %>
<%@ Register Src="~/PasswordRegexed.ascx" TagPrefix="uc1" TagName="Regex" %>
...
<script>
	(function (
		...
		,
		document.getElementById("<%=Regex.ClientID%>")
		,
