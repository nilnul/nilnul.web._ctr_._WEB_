<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.radio_._vertical.Js" %>
						...
						fill$:{
							value:function ($parentOfHolders) {
								...
								for (var i = 0;i<contents2b.length; i++) {
									$btnsHolder.append(
										$("<button>").css("width","100%").append(contents2b[i])
									);
								}
								<%--
