...
<%@ Register Src="~/Regex3.ascx" TagPrefix="uc1" TagName="Regex" %>
...
<label style="display: inline-block; border: 1px solid gray;" id="<%=ClientID %>">
	...
	<script>
		...
		pub = function () {
			...
			@see isValid
			*/
			boxer.hasErr = function () { return !regex.regexTestedGet(); };
			boxer.isValid = function () { return regex.regexTestedGet(); };
