<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EmailRequired.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.EmailRequired" %>

<%@ Register src="Regex.ascx" tagname="Regex" tagprefix="uc1" %>
