<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Js.ascx.cs" Inherits="nilnul.web._ctr_._WEB_.tabs_._trio.Js" %>
			...
			,pub = function () {
				Object.defineProperties(
					boxer,
					{
						...
						replaceInPane2:{
							value:function (ele) {
								panes.replaceInPane2(ele);
							}
						}
						,
						panePostUri:{
							value:function (paneIndex, uri, callback) {
								panes.postUri(paneIndex,uri,callback);
